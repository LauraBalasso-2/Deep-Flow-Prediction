...
class LatentSlicesDataset(Dataset):
    ...
    def get_normalization_parameters(self):
        ...
        max_inputs_0 = np.max(np.abs(self.inputs[:, :-2, :, :]))
        max_inputs_1 = np.max(np.abs(self.inputs[:, -2, :, :]))
        max_inputs_2 = np.max(np.abs(self.inputs[:, -1, :, :]))
        ...
        return {"max_input_latent": max_inputs_0, "max_input_dp": max_inputs_1, "max_input_z": max_inputs_2,
                "max_target_0": max_targets_0, "max_target_1": max_targets_1, "max_target_2": max_targets_2}

    def normalize(self):
        self.inputs[:, :-2, :, :] *= (1.0 / self.normalization_parameters.get("max_input_latent"))
        self.inputs[:, -2, :, :] *= (1.0 / self.normalization_parameters.get("max_input_dp"))
        self.inputs[:, -1, :, :] *= (1.0 / self.normalization_parameters.get("max_input_z"))
